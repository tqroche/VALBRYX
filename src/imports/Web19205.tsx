...
function CallToAction() {
  return (
    <div className="absolute contents left-[97px] top-[2234px]" data-name="Call to Action">
      <p className="-translate-x-1/2 absolute font-['Rethink_Sans:Regular',sans-serif] font-normal h-[52px] leading-[0] left-[530px] overflow-hidden text-[#03035e] text-[42px] text-center text-ellipsis top-[2234px] w-[866px] whitespace-nowrap">
...
function Footer() {
  return (
    <div className="absolute h-[146px] left-0 overflow-clip top-[2478px] w-[1080px]" data-name="Footer 7">
      ...
      <p className="absolute font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[24px] left-[561px] text-[14px] text-white top-[63px] whitespace-nowrap">© 2026 VALBRYX™. All Rights Reserved.</p>
      <p className="absolute font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[24px] left-[162px] text-[14px] text-white top-[63px] whitespace-nowrap">“Where strategy meets opportunity.”</p>
      <Social />
...
function Group() {
  return (
    <div className="absolute contents left-[193px] top-[2310px]">
      <p className="-translate-x-1/2 absolute font-['Rethink_Sans:Regular',sans-serif] font-normal h-[19px] leading-[19px] left-[540px] overflow-hidden text-[#03035e] text-[21px] text-center text-ellipsis top-[2310px] w-[694px] whitespace-nowrap">Let’s Secure Your Next Asset.</p>
      <div className="absolute bg-[#c68a2a] border-2 border-[#c68a2a] border-solid h-[40px] left-[471px] rounded-[4px] top-[2370px] w-[120px]" />
      <p className="-translate-x-1/2 absolute font-['Rethink_Sans:Bold',sans-serif] font-bold leading-[12px] left-[531px] text-[10px] text-center text-white top-[2384px] whitespace-nowrap">LET’S GET STARTED</p>
    </div>
  );
}
...
function NavBar() {
  return (
    <div className="absolute h-[134px] left-0 overflow-clip top-0 w-[1080px]" data-name="Nav bar 2">
      ...
      <p className="absolute font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[12px] left-[673px] text-[10px] text-white top-[21px] whitespace-nowrap">ABOUT</p>
      <p className="absolute font-['Rethink_Sans:Regular',sans-serif] font-normal leading-[12px] left-[750px] text-[10px] text-white top-[21px] whitespace-nowrap">INVESTMENTS</p>
...
function Header() {
  return (
    <div className="absolute contents left-[99.03px] top-[442.1px]" data-name="Header">
      <p className="absolute capitalize font-['Instrument_Sans:Regular',sans-serif] font-normal leading-[52px] left-[99.03px] text-[#f1f9ff] text-[41px] top-[442.1px] w-[631.967px]" style={{ fontVariationSettings: "'wdth' 100" }}>
...
export default function Web() {
  return (
    <div className="bg-white relative size-full" data-name="Web 1920 – 5">
      ...
      <p className="absolute font-['Rethink_Sans:Regular',sans-serif] font-normal h-[53px] leading-[normal] left-[102px] text-[#c68a2a] text-[41px] top-[1028px] w-[333px]">Venture Property</p>
      <p className="absolute font-['Rethink_Sans:Regular',sans-serif] font-normal h-[53px] leading-[normal] left-[102px] text-[#c68a2a] text-[41px] top-[1602px] w-[428px]">Property Management</p>
      ...
      <p className="absolute font-['Rethink_Sans:Regular',sans-serif] font-normal h-[80px] leading-[45px] left-[577px] text-[#c68a2a] text-[41px] top-[1197px] w-[404px]">Multi-Family Residences</p>
