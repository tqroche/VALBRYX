...
function Header() {
  return (
    <div className="absolute contents left-[86.03px] top-[442.1px]" data-name="Header">
      <p className="absolute capitalize font-['Instrument Sans',sans-serif] font-normal leading-[52px] left-[86.03px] text-[#f1f9ff] text-[41px] top-[442.1px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function CallToAction() {
  return (
    <div className="absolute contents left-[97px] top-[2414px]" data-name="Call to Action">
      <p className="-translate-x-1/2 absolute font-['Rethink Sans',sans-serif] font-normal h-[52px] leading-[0] left-[530px] overflow-hidden text-[#03035e] text-[42px] text-center text-ellipsis top-[2414px] w-[866px] whitespace-nowrap">
...
function NavBar() {
  return (
    <div className="absolute h-[134px] left-0 overflow-clip top-0 w-[1080px]" data-name="Nav bar 2">
      ...
      <p className="absolute font-['Rethink Sans',sans-serif] font-normal leading-[12px] left-[765px] text-[10px] text-white top-[21px] whitespace-nowrap">FIND A HOME</p>
...
function Footer() {
  return (
    <div className="absolute h-[146px] left-0 overflow-clip top-[2658px] w-[1080px]" data-name="Footer 7">
      ...
      <p className="absolute font-['Rethink Sans',sans-serif] font-bold leading-[12px] left-[212px] text-[#c68a2a] text-[10px] top-[45px] uppercase whitespace-nowrap">Find A Home</p>
      <div className="absolute font-['Rethink Sans',sans-serif] font-normal leading-[0] left-[212px] text-[14px] text-white top-[63px] whitespace-nowrap">
        <p className="leading-[24px] mb-0">We are ready for the challenge</p>
        <p className="leading-[24px]">adobexd@mail.com</p>
      </div>
      <div className="absolute font-['Rethink Sans',sans-serif] font-normal leading-[0] left-[506px] text-[14px] text-white top-[63px] whitespace-nowrap">
        <p className="leading-[24px] mb-0">497 Evergreen Rd. Roseville, CA 95673</p>
        <p className="leading-[24px]">+44 345 678 903</p>
      </div>
      <p className="absolute font-['Rethink Sans',sans-serif] font-bold leading-[12px] left-[506px] text-[#c68a2a] text-[10px] top-[45px] whitespace-nowrap">SAY HELLO</p>
      <Social />
...
function Group() {
  return (
    <div className="absolute contents left-[193px] top-[2490px]">
      <p className="-translate-x-1/2 absolute font-['Rethink Sans',sans-serif] font-normal h-[19px] leading-[19px] left-[540px] overflow-hidden text-[#03035e] text-[21px] text-center text-ellipsis top-[2490px] w-[694px] whitespace-nowrap">Let’s Secure Your Next Asset.</p>
      <div className="absolute bg-[#c68a2a] border-2 border-[#c68a2a] border-solid h-[40px] left-[471px] rounded-[4px] top-[2550px] w-[120px]" />
      <p className="-translate-x-1/2 absolute font-['Rethink Sans',sans-serif] font-bold leading-[12px] left-[531px] text-[10px] text-center text-white top-[2564px] whitespace-nowrap">LET’S GET STARTED</p>
    </div>
  );
}
...
function Header1() {
  return (
    <div className="absolute contents left-[200px] top-[1113px]" data-name="Header">
      <p className="absolute capitalize font-['Inter',sans-serif] font-normal inset-[39.69%_61.3%_58.1%_20.28%] leading-[62px] not-italic text-[#c68a2a] text-[24px] whitespace-nowrap">Home Acquisition</p>
...
function Header2() {
  return (
    <div className="absolute contents left-[200px] top-[1511px]" data-name="Header">
      <p className="absolute capitalize font-['Inter',sans-serif] font-normal leading-[62px] left-[222.43px] not-italic text-[#c68a2a] text-[24px] top-[1511px] whitespace-nowrap">{`Market Analysis & lead Generation`}</p>
...
function Header3() {
  return (
    <div className="absolute contents left-[200px] top-[1300px]" data-name="Header">
      <p className="absolute capitalize font-['Inter',sans-serif] font-normal leading-[62px] left-[219.43px] not-italic text-[#c68a2a] text-[24px] top-[1300px] whitespace-nowrap">Property Selling</p>
...
function Header4() {
  return (
    <div className="absolute contents left-[200px] top-[1581px]" data-name="Header">
      <p className="absolute capitalize font-['Inter',sans-serif] font-normal leading-[62px] left-[221.43px] not-italic text-[#c68a2a] text-[24px] top-[1581px] whitespace-nowrap">{`Paperwork & Compliance`}</p>
...
function Header5() {
  return (
    <div className="absolute contents left-[200px] top-[1370px]" data-name="Header">
      <p className="absolute font-['Inter',sans-serif] font-normal leading-[62px] left-[220.43px] not-italic text-[#c68a2a] text-[24px] top-[1370px] whitespace-nowrap">Coordination with Other Professionals</p>
...
function Header6() {
  return (
    <div className="absolute contents left-[200px] top-[1440px]" data-name="Header">
      <p className="absolute font-['Inter',sans-serif] font-normal leading-[0] left-[221.43px] not-italic text-[#c68a2a] text-[24px] top-[1440px] whitespace-nowrap">
