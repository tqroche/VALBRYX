import svgPaths from "./svg-tmhkbkaqcm";
...
function ScrollGroup() {
  return (
    <div className="absolute contents left-0 top-[54px]" data-name="Scroll Group 2">
      <div className="absolute h-[282px] left-0 top-[54px] w-[1080px]" data-name="curology-TITp0O0Ue70-unsplash">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[259%] left-[-0.71%] max-w-none top-[-104.32%] w-[101.43%]" src={imgCurologyTiTp0O0Ue70Unsplash} />
        </div>
      </div>
    </div>
  );
...
function InputTyping() {
  return (
    <div className="absolute contents left-[137px] top-[867px]" data-name="Input - Typing">
      <div className="absolute h-[50px] left-[137px] top-[867px] w-[566px]" data-name="Path 217">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 566 50">
...
function Attention() {
  return (
    <div className="absolute left-[667px] size-[16px] top-[784px]" data-name="Attention">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g clipPath="url(#clip0_1_74)" id="Attention">
          <path d={svgPaths.pbdf4e00} fill="var(--fill-0, #03035E)" id="Path 35" />
        </g>
        <defs>
...
function Social() {
  return (
    <div className="absolute h-[14px] left-[973px] top-[44px] w-[46.311px]" data-name="Social">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 46.3111 14">
        <g id="Social">
          <path d={svgPaths.p135323c0} fill="var(--fill-0, #C68A2A)" id="Path 38" />
...
export default function Web() {
  return (
    <div className="bg-white relative size-full" data-name="Web 1920 – 3">
      ...
      <TextboxEmpty />
      <Component />
      <div className="absolute h-[412px] left-0 top-[1363px] w-[1080px]" data-name="AdobeStock_57688175">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
