...
function ContactInfoColumn() {
  return (
    <div className="w-full lg:w-[28%] lg:max-w-[320px] lg:ml-[20%] lg:pl-6 lg:border-l lg:border-[#9aa6b2] lg:border-solid lg:border-t-0 lg:border-r-0 lg:border-b-0 mb-[64px] lg:mb-0 pb-0 p-0 text-[#03045e]">
